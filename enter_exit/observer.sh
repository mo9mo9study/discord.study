...
if [ ${strStatus} -eq 1 ]; then
    source /home/ec2-user/discord/enter_exit/.env
    /usr/bin/python3 /home/ec2-user/discord/enter_exit/enter_exit_bot.py 1>> /var/log/discord/enterBot/success.log 2>> /var/log/discord/enterBot/error.log
