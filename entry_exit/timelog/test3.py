...
TOKEN="NjYwNDg5OTA1NDUzMTM3OTMx.XjWRCg.8LLHpRJ-OraylvnJGxPctr-zEDQ"
CHANNEL=657225044971356173
...
for dirUserName in dirListName:
    ...
    strWeekResult += "　合計勉強時間：" + str(calTime(sumTime))+ "(勉強日数：" + str(len(studyWeekday)) + " )\n"
